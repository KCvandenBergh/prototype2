/*! howler.js v2.2.3 | (c) 2013-2020, James Simpson of GoldFire Studios | MIT License | howlerjs.com */ !function() {
    ...
    e1.prototype = {
        init: function() {
            var e = this || n2;
            return e._counter = 1000, e._html5AudioPool = [], e.html5PoolSize = 10, e._codecs = {}, e._howls = [], e._muted = !1, e._volume = 1, e._canPlayEvent = "canplaythrough", e._navigator = "undefined" != typeof window && window.navigator ? window.navigator : null, e.masterGain = null, e.noAudio = !1, e.usingWebAudio = !0, e.autoSuspend = !0, e.ctx = null, e.autoUnlock = !0, e._setup(), e;
        },
        volume: function(e) {
            var o = this || n2;
            if (e = parseFloat(e), o.ctx || _1(), void 0 !== e && e >= 0 && e <= 1) {
                if (o._volume = e, o._muted) return o;
                o.usingWebAudio && o.masterGain.gain.setValueAtTime(e, n2.ctx.currentTime);
        ...
        mute: function(e) {
            var o = this || n2;
            o.ctx || _1(), o._muted = e, o.usingWebAudio && o.masterGain.gain.setValueAtTime(e ? 0 : o._volume, n2.ctx.currentTime);
            for(var t = 0; t < o._howls.length; t++)if (!o._howls[t]._webAudio) for(var r = o._howls[t]._getSoundIds(), a = 0; a < r.length; a++){
                var u = o._howls[t]._soundById(r[a]);
        ...
        stop: function() {
            for(var e = this || n2, o = 0; o < e._howls.length; o++)e._howls[o].stop();
            return e;
        },
        unload: function() {
            for(var e = this || n2, o = e._howls.length - 1; o >= 0; o--)e._howls[o].unload();
            return e.usingWebAudio && e.ctx && void 0 !== e.ctx.close && (e.ctx.close(), e.ctx = null, _1()), e;
        },
        codecs: function(e) {
            return (this || n2)._codecs[e.replace(/^x-/, "")];
        },
        _setup: function() {
            var e = this || n2;
        ...
        _autoSuspend: function() {
            var e = this;
            if (e.autoSuspend && e.ctx && void 0 !== e.ctx.suspend && n2.usingWebAudio) {
        ...
        _autoResume: function() {
            var e = this;
            if (e.ctx && void 0 !== e.ctx.resume && n2.usingWebAudio) return "running" === e.state && "interrupted" !== e.ctx.state && e._suspendTimer ? (clearTimeout(e._suspendTimer), e._suspendTimer = null) : "suspended" === e.state || "running" === e.state && "interrupted" === e.ctx.state ? (e.ctx.resume().then(function() {
                e.state = "running";
                for(var n = 0; n < e._howls.length; n++)e._howls[n]._emit("resume");
            }), e._suspendTimer && (clearTimeout(e._suspendTimer), e._suspendTimer = null)) : "suspending" === e.state && (e._resumeAfterSuspend = !0), e;
        }
    };
    var n2 = new e1, o1 = function(e) {
        var n = this;
    ...
    o1.prototype = {
        init: function(e) {
            var o = this;
            return n2.ctx || _1(), o._autoplay = e.autoplay || !1, o._format = "string" != typeof e.format ? e.format : [
                e.format
            ...
            ] : [], o._onresume = [], o._webAudio = n2.usingWebAudio && !o._html5, void 0 !== n2.ctx && n2.ctx && n2.autoUnlock && n2._unlockAudio(), n2._howls.push(o), o._autoplay && o._queue.push({
                event: "play",
                action: function() {
                    o.play();
                }
        ...
        load: function() {
            var e = this, o = null;
            if (n2.noAudio) return void e._emit("loaderror", null, "No audio support.");
            ...
            for(var r = 0; r < e._src.length; r++){
                ...
                if (u || console.warn('No file extension was found. Consider using the "format" property or specify an extension.'), u && n2.codecs(u)) {
                    o = e._src[r];
                    break;
                }
            }
            return o ? (e._src = o, e._state = "loading", "https:" === window.location.protocol && "http:" === o.slice(0, 5) && (e._html5 = !0, e._webAudio = !1), new t1(e), e._webAudio && a1(e), e) : void e._emit("loaderror", null, "No codec support for selected audio sources.");
        },
        play: function(e3, o) {
            var t = this, r2 = null;
            if ("number" == typeof e3) r2 = e3, e3 = null;
            else {
                if ("string" == typeof e3 && "loaded" === t._state && !t._sprite[e3]) return null;
                if (void 0 === e3 && (e3 = "__default", !t._playLock)) {
                    for(var a = 0, u = 0; u < t._sounds.length; u++)t._sounds[u]._paused && !t._sounds[u]._ended && (a++, r2 = t._sounds[u]._id);
                    1 === a ? e3 = null : r2 = null;
                }
            }
            var d = r2 ? t._soundById(r2) : t._inactiveSound();
            if (!d) return null;
            if (r2 && !e3 && (e3 = d._sprite || "__default"), "loaded" !== t._state) {
                d._sprite = e3, d._ended = !1;
                var i = d._id;
            ...
            if (r2 && !d._paused) return o || t._loadQueue("play"), d._id;
            t._webAudio && n2._autoResume();
            var _ = Math.max(0, d._seek > 0 ? d._seek : t._sprite[e3][0] / 1000), s = Math.max(0, (t._sprite[e3][0] + t._sprite[e3][1]) / 1000 - _), l = 1000 * s / Math.abs(d._rate), c = t._sprite[e3][0] / 1000, f = (t._sprite[e3][0] + t._sprite[e3][1]) / 1000;
            d._sprite = e3, d._ended = !1;
            var p = function() {
                d._paused = !1, d._seek = _, d._start = c, d._stop = f, d._loop = !(!d._loop && !t._sprite[e3][2]);
            };
            ...
            if (t._webAudio) {
                var v = function() {
                    ...
                    m.gain.setValueAtTime(e, n2.ctx.currentTime), d._playStart = n2.ctx.currentTime, void 0 === m.bufferSource.start ? d._loop ? m.bufferSource.noteGrainOn(0, _, 86400) : m.bufferSource.noteGrainOn(0, _, s) : d._loop ? m.bufferSource.start(0, _, 86400) : m.bufferSource.start(0, _, s), l !== 1 / 0 && (t._endTimers[d._id] = setTimeout(t._ended.bind(t, d), l)), o || setTimeout(function() {
                        t._emit("play", d._id), t._loadQueue();
                    }, 0);
                };
                "running" === n2.state && "interrupted" !== n2.ctx.state ? v() : (t._playLock = !0, t.once("resume", v), t._clearTimer(d._id));
            } else {
                var h = function() {
                    m.currentTime = _, m.muted = d._muted || t._muted || n2._muted || m.muted, m.volume = d._volume * n2.volume(), m.playbackRate = d._rate;
                    try {
                        var r = m.play();
                        ...
                        "__default" !== e3 || d._loop ? t._endTimers[d._id] = setTimeout(t._ended.bind(t, d), l) : (t._endTimers[d._id] = function() {
                ...
                var y = window && window.ejecta || !m.readyState && n2._navigator.isCocoonJS;
                if (m.readyState >= 3 || y) h();
                else {
                    t._playLock = !0, t._state = "loading";
                    var g = function() {
                        t._state = "loaded", h(), m.removeEventListener(n2._canPlayEvent, g, !1);
                    };
                    m.addEventListener(n2._canPlayEvent, g, !1), t._clearTimer(d._id);
                }
            }
            return d._id;
        },
        ...
        mute: function(e, o) {
            ...
            for(var r = t._getSoundIds(o), a = 0; a < r.length; a++){
                ...
                u && (u._muted = e, u._interval && t._stopFade(u._id), t._webAudio && u._node ? u._node.gain.setValueAtTime(e ? 0 : u._volume, n2.ctx.currentTime) : u._node && (u._node.muted = !!n2._muted || e), t._emit("mute", u._id));
            }
            return t;
        },
        volume: function() {
            ...
            for(var u = 0; u < o.length; u++)(a = t._soundById(o[u])) && (a._volume = e, r[2] || t._stopFade(o[u]), t._webAudio && a._node && !a._muted ? a._node.gain.setValueAtTime(e, n2.ctx.currentTime) : a._node && !a._muted && (a._node.volume = e * n2.volume()), t._emit("volume", a._id));
            return t;
        },
            ...
            for(var u = a._getSoundIds(r), d = 0; d < u.length; d++){
                ...
                if (i) {
                    if (r || a._stopFade(u[d]), a._webAudio && !i._muted) {
                        var _ = n2.ctx.currentTime, s = _ + t / 1000;
        ...
        _startFadeInterval: function(e, n, o, t, r3, a) {
            var u = this, d = n, i = o - n, _ = Math.abs(i / 0.01), s = Math.max(4, _ > 0 ? t / _ : t), l = Date.now();
        ...
        _stopFade: function(e) {
            ...
            return t && t._interval && (o._webAudio && t._node.gain.cancelScheduledValues(n2.ctx.currentTime), clearInterval(t._interval), t._interval = null, o.volume(t._fadeTo, e), t._fadeTo = null, o._emit("fade", e)), o;
        },
        loop: function() {
        ...
        rate: function() {
            ...
            for(var i = 0; i < o.length; i++)if (d = t._soundById(o[i])) {
                t.playing(o[i]) && (d._rateSeek = t.seek(o[i]), d._playStart = t._webAudio ? n2.ctx.currentTime : d._playStart), d._rate = e, t._webAudio && d._node && d._node.bufferSource ? d._node.bufferSource.playbackRate.setValueAtTime(e, n2.ctx.currentTime) : d._node && (d._node.playbackRate = e);
                var _ = t.seek(o[i]), s = (t._sprite[d._sprite][0] + t._sprite[d._sprite][1]) / 1000 - _, l = 1000 * s / Math.abs(d._rate);
        ...
        seek: function() {
            ...
            if (d) {
                if (!("number" == typeof e && e >= 0)) {
                    if (t._webAudio) {
                        var i = t.playing(o) ? n2.ctx.currentTime - d._playStart : 0, _ = d._rateSeek ? d._rateSeek - d._seek : 0;
        ...
        duration: function(e) {
            ...
            return t && (o = n._sprite[t._sprite][1] / 1000), o;
        },
        state: function() {
            return this._state;
        },
        unload: function() {
            for(var e = this, o = e._sounds, t = 0; t < o.length; t++)o[t]._paused || e.stop(o[t]._id), e._webAudio || (e._clearSound(o[t]._node), o[t]._node.removeEventListener("error", o[t]._errorFn, !1), o[t]._node.removeEventListener(n2._canPlayEvent, o[t]._loadFn, !1), o[t]._node.removeEventListener("ended", o[t]._endFn, !1), n2._releaseHtml5Audio(o[t]._node)), delete o[t]._node, e._clearTimer(o[t]._id);
            var a = n2._howls.indexOf(e);
            a >= 0 && n2._howls.splice(a, 1);
            var u = !0;
            for(t = 0; t < n2._howls.length; t++)if (n2._howls[t]._src === e._src || e._src.indexOf(n2._howls[t]._src) >= 0) {
                u = !1;
                break;
            }
            return r1 && u && delete r1[e._src], n2.noAudio = !1, e._state = "unloaded", e._sounds = [], e = null, null;
        },
        on: function(e, n, o, t) {
        ...
        _emit: function(e4, n, o) {
            for(var t = this, r = t["_on" + e4], a = r.length - 1; a >= 0; a--)r[a].id && r[a].id !== n && "load" !== e4 || (setTimeout((function(e) {
                e.call(this, n, o);
            }).bind(t, r[a].fn), 0), r[a].once && t.off(e4, r[a].fn, r[a].id));
            return t._loadQueue(e4), t;
        },
        ...
        _ended: function(e) {
            ...
            if (o._emit("end", e._id), !o._webAudio && r && o.stop(e._id, !0).play(e._id), o._webAudio && r) {
                o._emit("play", e._id), e._seek = e._start || 0, e._rateSeek = 0, e._playStart = n2.ctx.currentTime;
                var a = 1000 * (e._stop - e._start) / Math.abs(e._rate);
                o._endTimers[e._id] = setTimeout(o._ended.bind(o, e), a);
            }
            return o._webAudio && !r && (e._paused = !0, e._ended = !0, e._seek = e._start || 0, e._rateSeek = 0, o._clearTimer(e._id), o._cleanBuffer(e._node), n2._autoSuspend()), o._webAudio || r || o.stop(e._id, !0), o;
        },
        ...
        _refreshBuffer: function(e) {
            var o = this;
            return e._node.bufferSource = n2.ctx.createBufferSource(), e._node.bufferSource.buffer = r1[o._src], e._panner ? e._node.bufferSource.connect(e._panner) : e._node.bufferSource.connect(e._node), e._node.bufferSource.loop = e._loop, e._loop && (e._node.bufferSource.loopStart = e._start || 0, e._node.bufferSource.loopEnd = e._stop || 0), e._node.bufferSource.playbackRate.setValueAtTime(e._rate, n2.ctx.currentTime), o;
        },
        _cleanBuffer: function(e) {
            var o = this, t = n2._navigator && n2._navigator.vendor.indexOf("Apple") >= 0;
            if (n2._scratchBuffer && e.bufferSource && (e.bufferSource.onended = null, e.bufferSource.disconnect(0), t)) try {
                e.bufferSource.buffer = n2._scratchBuffer;
            } catch (e5) {}
            return e.bufferSource = null, o;
        },
        _clearSound: function(e) {
            /MSIE |Trident\//.test(n2._navigator && n2._navigator.userAgent) || (e.src = "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA");
        }
    };
    var t1 = function(e) {
    ...
    t1.prototype = {
        init: function() {
            ...
            return e._muted = o._muted, e._loop = o._loop, e._volume = o._volume, e._rate = o._rate, e._seek = 0, e._paused = !0, e._ended = !0, e._sprite = "__default", e._id = ++n2._counter, o._sounds.push(e), e.create(), e;
        },
        create: function() {
            var e = this, o = e._parent, t = n2._muted || e._muted || e._parent._muted ? 0 : e._volume;
            return o._webAudio ? (e._node = void 0 === n2.ctx.createGain ? n2.ctx.createGainNode() : n2.ctx.createGain(), e._node.gain.setValueAtTime(t, n2.ctx.currentTime), e._node.paused = !0, e._node.connect(n2.masterGain)) : n2.noAudio || (e._node = n2._obtainHtml5Audio(), e._errorFn = e._errorListener.bind(e), e._node.addEventListener("error", e._errorFn, !1), e._loadFn = e._loadListener.bind(e), e._node.addEventListener(n2._canPlayEvent, e._loadFn, !1), e._endFn = e._endListener.bind(e), e._node.addEventListener("ended", e._endFn, !1), e._node.src = o._src, e._node.preload = !0 === o._preload ? "auto" : o._preload, e._node.volume = t * n2.volume(), e._node.load()), e;
        },
        reset: function() {
            var e = this, o = e._parent;
            return e._muted = o._muted, e._loop = o._loop, e._volume = o._volume, e._rate = o._rate, e._seek = 0, e._rateSeek = 0, e._paused = !0, e._ended = !0, e._sprite = "__default", e._id = ++n2._counter, e;
        },
        ...
        _loadListener: function() {
            ...
            }), "loaded" !== o._state && (o._state = "loaded", o._emit("load"), o._loadQueue()), e._node.removeEventListener(n2._canPlayEvent, e._loadFn, !1);
        },
        _endListener: function() {
            var e = this, n = e._parent;
            n._duration === 1 / 0 && (n._duration = Math.ceil(10 * e._node.duration) / 10, n._sprite.__default[1] === 1 / 0 && (n._sprite.__default[1] = 1000 * n._duration), n._ended(e)), e._node.removeEventListener("ended", e._endFn, !1);
        }
    };
    var r1 = {}, a1 = function(e) {
        var n4 = e._src;
        if (r1[n4]) return e._duration = r1[n4].duration, void i1(e);
        if (/^data:[^;]+;base64,/.test(n4)) {
            for(var o = atob(n4.split(",")[1]), t = new Uint8Array(o.length), a = 0; a < o.length; ++a)t[a] = o.charCodeAt(a);
            d1(t.buffer, e);
        } else {
            var _ = new XMLHttpRequest;
            _.open(e._xhr.method, n4, !0), _.withCredentials = e._xhr.withCredentials, _.responseType = "arraybuffer", e._xhr.headers && Object.keys(e._xhr.headers).forEach(function(n) {
                ...
                e._webAudio && (e._html5 = !0, e._webAudio = !1, e._sounds = [], delete r1[n4], e.load());
            }, u1(_);
        }
    }, u1 = function(e) {
        try {
        ...
        var t = function() {
            ...
            e && o._sounds.length > 0 ? (r1[o._src] = e, i1(o, e)) : t();
        };
        "undefined" != typeof Promise && 1 === n2.ctx.decodeAudioData.length ? n2.ctx.decodeAudioData(e6).then(a).catch(t) : n2.ctx.decodeAudioData(e6, a, t);
    }, i1 = function(e, n) {
        ...
        if (n2.usingWebAudio) {
            try {
                "undefined" != typeof AudioContext ? n2.ctx = new AudioContext : "undefined" != typeof webkitAudioContext ? n2.ctx = new webkitAudioContext : n2.usingWebAudio = !1;
            } catch (e7) {
                n2.usingWebAudio = !1;
            }
            n2.ctx || (n2.usingWebAudio = !1);
            var e = /iP(hone|od|ad)/.test(n2._navigator && n2._navigator.platform), o = n2._navigator && n2._navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/), t = o ? parseInt(o[1], 10) : null;
            if (e && t && t < 9) {
                var r = /safari/.test(n2._navigator && n2._navigator.userAgent.toLowerCase());
                n2._navigator && !r && (n2.usingWebAudio = !1);
            }
            n2.usingWebAudio && (n2.masterGain = void 0 === n2.ctx.createGain ? n2.ctx.createGainNode() : n2.ctx.createGain(), n2.masterGain.gain.setValueAtTime(n2._muted ? 0 : n2._volume, n2.ctx.currentTime), n2.masterGain.connect(n2.ctx.destination)), n2._setup();
        }
    };
    ...
    }), "undefined" != typeof exports && (exports.Howler = n2, exports.Howl = o1), "undefined" != typeof global ? (global.HowlerGlobal = e1, global.Howler = n2, global.Howl = o1, global.Sound = t1) : "undefined" != typeof window && (window.HowlerGlobal = e1, window.Howler = n2, window.Howl = o1, window.Sound = t1);
}();
/*! Spatial Plugin */ !function() {
    HowlerGlobal.prototype._pos = [
        ...
        return n = "number" != typeof n ? s[1] : n, t = "number" != typeof t ? s[2] : t, r = "number" != typeof r ? s[3] : r, o = "number" != typeof o ? s[4] : o, i = "number" != typeof i ? s[5] : i, "number" != typeof e ? s : (a._orientation = [
            e,
            n,
            t,
            r,
        ...
        return function(n) {
            ...
            return t._orientation = n.orientation || [
                ...
                maxDistance: void 0 !== n.maxDistance ? n.maxDistance : 10000,
        ...
        for(var i = r._getSoundIds(t), a = 0; a < i.length; a++){
            ...
            if (s) {
                ...
                s._stereo = n, s._pos = [
                    ...
                    0,
                    0
                ], s._node && (s._pannerAttr.panningModel = "equalpower", s._panner && s._panner.pan || e8(s, o), "spatial" === o ? void 0 !== s._panner.positionX ? (s._panner.positionX.setValueAtTime(n, Howler.ctx.currentTime), s._panner.positionY.setValueAtTime(0, Howler.ctx.currentTime), s._panner.positionZ.setValueAtTime(0, Howler.ctx.currentTime)) : s._panner.setPosition(n, 0, 0) : s._panner.pan.setValueAtTime(n, Howler.ctx.currentTime)), r._emit("stereo", s._id);
            }
        }
        return r;
        ...
        for(var a = i._getSoundIds(o), s = 0; s < a.length; s++){
            ...
            if (p) {
                ...
                p._pos = [
                    ...
                    t,
                    r
                ], p._node && (p._panner && !p._panner.pan || e8(p, "spatial"), void 0 !== p._panner.positionX ? (p._panner.positionX.setValueAtTime(n, Howler.ctx.currentTime), p._panner.positionY.setValueAtTime(t, Howler.ctx.currentTime), p._panner.positionZ.setValueAtTime(r, Howler.ctx.currentTime)) : p._panner.setPosition(n, t, r)), i._emit("pos", p._id);
            }
        }
        return i;
        ...
        for(var a = i._getSoundIds(o), s = 0; s < a.length; s++){
            ...
            if (p) {
                ...
                p._orientation = [
                    ...
                    0,
                    -0.5
                ]), e8(p, "spatial")), void 0 !== p._panner.orientationX ? (p._panner.orientationX.setValueAtTime(n, Howler.ctx.currentTime), p._panner.orientationY.setValueAtTime(t, Howler.ctx.currentTime), p._panner.orientationZ.setValueAtTime(r, Howler.ctx.currentTime)) : p._panner.setOrientation(n, t, r)), i._emit("orientation", p._id);
            }
        }
        return i;
        ...
        for(var a = o._getSoundIds(t), s = 0; s < a.length; s++)if (r = o._soundById(a[s])) {
            ...
            var c = r._panner;
            c ? (c.coneInnerAngle = p.coneInnerAngle, c.coneOuterAngle = p.coneOuterAngle, c.coneOuterGain = p.coneOuterGain, c.distanceModel = p.distanceModel, c.maxDistance = p.maxDistance, c.refDistance = p.refDistance, c.rolloffFactor = p.rolloffFactor, c.panningModel = p.panningModel) : (r._pos || (r._pos = o._pos || [
                0,
                0,
                -0.5
            ]), e8(r, "spatial"));
...
//# sourceMappingURL=index.eee9d48a.js.map
